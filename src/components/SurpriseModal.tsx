  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="relative max-w-lg overflow-hidden rounded-[2rem] bg-card p-8 text-center shadow-soft sm:p-12"
            onClick={(e) => e.stopPropagation()}
          >
            <img src={bowImg} alt="" className="absolute -top-6 left-1/2 w-32 -translate-x-1/2" />
            <div className="mt-12">
